...
<Steps>
  ...
  <Step title="Click Export Tailwind v3">
...
<Steps>
  ...
  <Step title="Click Export Tailwind v4">
...
Tailwind v4 reads CSS custom properties declared inside `@theme` and makes them available as utility classes automatically. The exported file begins with `@import "tailwindcss";` so the theme block is self-contained.
